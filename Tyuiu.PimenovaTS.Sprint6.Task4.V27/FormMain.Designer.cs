...
namespace Tyuiu.PimenovaTS.Sprint6.Task4.V27
{
    partial class FormMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.chartFunction_PTS.ChartAreas.Add(chartArea1);
            ...
            this.chartFunction_PTS.Series.Add(series1);
            ...
            title1.Name = "Title1";
            title1.Text = "График функции (cos(x)/x+1)-cos(x)*1.3+3*x";
            this.chartFunction_PTS.Titles.Add(title1);
            // 
            // FormMain
            // 
            ...
            this.Text = "Спринт 6 | Таск 4 | Вариант 27 | Пименова Т. С.";
